...
Module create_assembly

    Sub Main()
        If My.Application.CommandLineArgs.Count < 3 Then
            Console.WriteLine("Usage: create_assembly.exe Project Name Description")
            Return
        End If
        ...
        Dim filename As String = name + ".sldasm"
        ...
        Try
            ...
            My.Computer.FileSystem.CopyFile("Resources\NewAssembly.sldasm", "Temp\" + filename)
